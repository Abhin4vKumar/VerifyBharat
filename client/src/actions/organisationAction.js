...
export const register = (userData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(`/api/v1/org/register`, userData, config);
...
export const loadUser = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`/api/v1/org/me`);
...
export const logout = () => async (dispatch) => {
  try {
    await axios.get(`/api/v1/org/logout`);
...
export const updateProfile = (userData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(`/api/v1/org/me/update`, userData, config);
...
export const forgotPassword = (email) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(`/api/v1/org/password/forgot`, email, config);
...
export const addEmployee = (userData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`/api/v1/org/hire`, userData, config);
...
export const removeEmployee = (userData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(`/api/v1/org/layoff`, userData, config);
